...
public class StrokeRenderer {
    ...
    public static void renderStrokes(List<Stroke> strokes, Stroke currentStroke, DrawContext context) {
    ...
    private static void renderStroke(DrawContext context, List<DrawPoint> points) {
